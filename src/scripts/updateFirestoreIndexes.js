...
console.log('   • orders: stato (ASC) + is_prioritario (ASC) + created_at (ASC)');
...
console.log('   https://console.firebase.google.com/v1/r/project/sagra-orders/firestore/indexes');
console.log('');
