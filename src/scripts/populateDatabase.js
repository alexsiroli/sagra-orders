...
// Configurazione Firebase - sostituisci con i tuoi valori reali
...
async function populateDatabase() {
  ...
  try {
    ...
    console.log('   👑 Admin: admin@locale.test / admin123 (PIN: 1234)');
    console.log('   💳 Cassa: cassa@locale.test / cassa123 (PIN: 5678)');
    console.log('   👨‍🍳 Cucina: cucina@locale.test / cucina123 (PIN: 9012)');
